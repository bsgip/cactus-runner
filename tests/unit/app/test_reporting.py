...
def test_pdf_report_everything_set():
    ...
    active_test_procedure = generate_class_instance(
        ...
        step_status={
            ...
            "GET-EDEV-LIST": StepInfo(
                started_at=now - timedelta(seconds=260), completed_at=now - timedelta(seconds=255)
            ),
            ...
            "GET-DER-STATUS": StepInfo(
                started_at=now - timedelta(seconds=180), completed_at=now - timedelta(seconds=175)
            ),
    ...
    request_history = [
        ...
        generate_class_instance(
            ...
            method=http.HTTPMethod.GET,
            status=http.HTTPStatus.OK,
            timestamp=now - timedelta(seconds=278),
            step_name="GET-DCAP",
            body_xml_errors=[],
        ),
        # GET-EDEV-LIST step
        ...
        generate_class_instance(
            ...
            method=http.HTTPMethod.GET,
            status=http.HTTPStatus.OK,
            timestamp=now - timedelta(seconds=258),
            step_name="GET-EDEV-LIST",
            body_xml_errors=[],
        ),
        generate_class_instance(
            ...
            method=http.HTTPMethod.GET,
            status=http.HTTPStatus.OK,
            timestamp=now - timedelta(seconds=256),
            step_name="GET-EDEV-LIST",
            body_xml_errors=[],
        ),
        # GET-TM step
        ...
        generate_class_instance(
            ...
            method=http.HTTPMethod.GET,
            status=http.HTTPStatus.OK,
            timestamp=now - timedelta(seconds=238),
            step_name="GET-TM",
            body_xml_errors=[],
        ),
        # GET-DER step
        ...
        # GET-DER-SETTINGS step
        generate_class_instance(
            RequestEntry,
            url="https://example.com/edev/1/der/derg",
            path="/edev/1/der/derg",
            method=http.HTTPMethod.GET,
            status=http.HTTPStatus.OK,
            timestamp=now - timedelta(seconds=200),
            step_name="GET-DER-SETTINGS",
            body_xml_errors=[],
        ),
        generate_class_instance(
            RequestEntry,
            ...
            method=http.HTTPMethod.GET,
            status=http.HTTPStatus.OK,
            timestamp=now - timedelta(seconds=198),
            step_name="GET-DER-SETTINGS",
            body_xml_errors=[],
        ),
        # GET-DER-STATUS step
        generate_class_instance(
            RequestEntry,
            url="https://example.com/edev/1/der/ders",
            path="/edev/1/der/ders",
            method=http.HTTPMethod.GET,
            status=http.HTTPStatus.OK,
            timestamp=now - timedelta(seconds=180),
            step_name="GET-DER-STATUS",
            body_xml_errors=[],
        ),
        generate_class_instance(
            RequestEntry,
            ...
            method=http.HTTPMethod.GET,
            status=http.HTTPStatus.OK,
            timestamp=now - timedelta(seconds=178),
            step_name="GET-DER-STATUS",
            body_xml_errors=[],
        ),
        generate_class_instance(
            ...
            method=http.HTTPMethod.GET,
            status=http.HTTPStatus.OK,
            timestamp=now - timedelta(seconds=176),
            step_name="GET-DER-STATUS",
            body_xml_errors=[],
        ),
        # PUT-DERP step
        generate_class_instance(
            RequestEntry,
            url="https://example.com/edev/1/derp",
            path="/edev/1/derp",
        ...
        generate_class_instance(
            RequestEntry,
            url="https://example.com/edev/1/derp/1",
            path="/edev/1/derp/1",
            method=http.HTTPMethod.GET,
            status=http.HTTPStatus.OK,
            timestamp=now - timedelta(seconds=158),
            step_name="PUT-DERP",
            body_xml_errors=[],
        ),
        # Additional requests scattered throughout
        generate_class_instance(
            RequestEntry,
            url="https://example.com/edev",
            path="/edev",
            method=http.HTTPMethod.GET,
            status=http.HTTPStatus.OK,
            timestamp=now - timedelta(seconds=140),
            step_name="Unmatched",
            body_xml_errors=[],
        ),
        generate_class_instance(
    ...
    timeline_start = now - timedelta(seconds=350)
    timeline = Timeline(
        timeline_start,
        20,
        [
